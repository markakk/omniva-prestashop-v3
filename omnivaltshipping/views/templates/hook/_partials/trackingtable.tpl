        ...
        <div class="table_block table-responsive">
            <table class="table table-striped table-bordered hidden-sm-down">
                <thead class="thead-default">
                    <tr>
                        <th class="last_item">{l s='Event ID' d='Modules.Omnivaltshipping.Shop'}</th>
                        <th class="last_item">{l s='Event' d='Modules.Omnivaltshipping.Shop'}</th>
                        <th class="item">{l s='Date' d='Modules.Omnivaltshipping.Shop'}</th>
                    </tr>
                </thead>
                <tbody>
